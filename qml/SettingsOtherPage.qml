                ...
                contentItem: ColumnLayout {
                    ...
                    CheckBox {
                        ...
                        Component.onCompleted: {
                            checked = backend && backend.settings ? Boolean(backend.settings.use_fixed_delays) : false
                        }
                        ...
                        Connections {
                            ...
                            function onSettingsChanged() {
                                fixedDelaysCheck.checked = backend && backend.settings ? Boolean(backend.settings.use_fixed_delays) : false
                            }
                        }
                    }
