            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    ColumnLayout {
                        ...
                        Text {
                            text: "Откройте «Настройки → Окно». Нажмите «Выбрать окно» и кликните мышкой на окно вашей игры Perfect World. Это обязательно — без выбора окна программа не сможет отправлять нажатия клавиш."
                            color: "#a2a2a2"
                            font.pointSize: 10
                        ...
                        Text {
                            text: "Откройте «Настройки → Калибровка». Нажмите на плитку «Дистанция» и проведите калибровку — выделите зону, где отображаются цифры дистанции до цели. Также включите «Проверку дистанции» в настройках «Движение»."
                            color: "#a2a2a2"
                            font.pointSize: 10
                            wrapMode: Text.WordWrap
                            Layout.fillWidth: true
                    ...
                    ColumnLayout {
                        ...
                        Text {
                            text: "В «Настройки → Калибровка» нажмите на плитку «Кастбар». Начните калибровку и кликните мышкой на полоску прогресса каста в интерфейсе игры — это нужно для определения момента завершения каста."
                            color: "#a2a2a2"
                            font.pointSize: 10
                            wrapMode: Text.WordWrap
                            Layout.fillWidth: true
