        ...
        GridLayout {
            ...
            GlassBlurPanel {
                ...
                Rectangle {
                    ...
                    height: parent.height + 40
                    radius: 10 + 20
                    color: Qt.rgba(друидClass.accentColor.r, друидClass.accentColor.g, друидClass.accentColor.b, друидMouseArea.containsMouse ? 0.005 : 0)
                    z: 0
                }
                Rectangle {
                    anchors.centerIn: parent
                    ...
                    height: parent.height + 35
                    radius: 10 + 17
                    color: Qt.rgba(друидClass.accentColor.r, друидClass.accentColor.g, друидClass.accentColor.b, друидMouseArea.containsMouse ? 0.01 : 0)
                    z: 0
                }
                Rectangle {
                    anchors.centerIn: parent
                    ...
                    height: parent.height + 30
                    radius: 10 + 15
                    color: Qt.rgba(друидClass.accentColor.r, друидClass.accentColor.g, друидClass.accentColor.b, друидMouseArea.containsMouse ? 0.015 : 0)
                    z: 0
                }
                Rectangle {
                    anchors.centerIn: parent
                    ...
                    height: parent.height + 25
                    radius: 10 + 12
                    color: Qt.rgba(друидClass.accentColor.r, друидClass.accentColor.g, друидClass.accentColor.b, друидMouseArea.containsMouse ? 0.02 : 0)
                    z: 0
                }
                Rectangle {
                    anchors.centerIn: parent
                    ...
                    height: parent.height + 20
                    radius: 10 + 10
                    color: Qt.rgba(друидClass.accentColor.r, друидClass.accentColor.g, друидClass.accentColor.b, друидMouseArea.containsMouse ? 0.03 : 0)
                    z: 0
                }
                Rectangle {
                    anchors.centerIn: parent
                    ...
                    height: parent.height + 15
                    radius: 10 + 7
                    color: Qt.rgba(друидClass.accentColor.r, друидClass.accentColor.g, друидClass.accentColor.b, друидMouseArea.containsMouse ? 0.04 : 0)
                    z: 0
                }
                Rectangle {
                    anchors.centerIn: parent
                    ...
                    height: parent.height + 10
                    radius: 10 + 5
                    color: Qt.rgba(друидClass.accentColor.r, друидClass.accentColor.g, друидClass.accentColor.b, друидMouseArea.containsMouse ? 0.05 : 0)
                    z: 0
                }
                Rectangle {
                    anchors.centerIn: parent
                    ...
                    height: parent.height + 6
                    radius: 10 + 3
                    color: Qt.rgba(друидClass.accentColor.r, друидClass.accentColor.g, друидClass.accentColor.b, друидMouseArea.containsMouse ? 0.06 : 0)
                    z: 0
                }
            ...
            GlassBlurPanel {
                ...
                Rectangle {
                    ...
                    height: parent.height + 40
                    radius: 10 + 20
                    color: Qt.rgba(жнецClass.accentColor.r, жнецClass.accentColor.g, жнецClass.accentColor.b, жнецMouseArea.containsMouse ? 0.005 : 0)
                    z: 0
                }
                Rectangle {
                    anchors.centerIn: parent
                    ...
                    height: parent.height + 35
                    radius: 10 + 17
                    color: Qt.rgba(жнецClass.accentColor.r, жнецClass.accentColor.g, жнецClass.accentColor.b, жнецMouseArea.containsMouse ? 0.01 : 0)
                    z: 0
                }
                Rectangle {
                    anchors.centerIn: parent
                    ...
                    height: parent.height + 30
                    radius: 10 + 15
                    color: Qt.rgba(жнецClass.accentColor.r, жнецClass.accentColor.g, жнецClass.accentColor.b, жнецMouseArea.containsMouse ? 0.015 : 0)
                    z: 0
                }
                Rectangle {
                    anchors.centerIn: parent
                    ...
                    height: parent.height + 25
                    radius: 10 + 12
                    color: Qt.rgba(жнецClass.accentColor.r, жнецClass.accentColor.g, жнецClass.accentColor.b, жнецMouseArea.containsMouse ? 0.02 : 0)
                    z: 0
                }
                Rectangle {
                    anchors.centerIn: parent
                    ...
                    height: parent.height + 20
                    radius: 10 + 10
                    color: Qt.rgba(жнецClass.accentColor.r, жнецClass.accentColor.g, жнецClass.accentColor.b, жнецMouseArea.containsMouse ? 0.03 : 0)
                    z: 0
                }
                Rectangle {
                    anchors.centerIn: parent
                    ...
                    height: parent.height + 15
                    radius: 10 + 7
                    color: Qt.rgba(жнецClass.accentColor.r, жнецClass.accentColor.g, жнецClass.accentColor.b, жнецMouseArea.containsMouse ? 0.04 : 0)
                    z: 0
                }
                Rectangle {
                    anchors.centerIn: parent
                    ...
                    height: parent.height + 10
                    radius: 10 + 5
                    color: Qt.rgba(жнецClass.accentColor.r, жнецClass.accentColor.g, жнецClass.accentColor.b, жнецMouseArea.containsMouse ? 0.05 : 0)
                    z: 0
                }
                Rectangle {
                    anchors.centerIn: parent
                    ...
                    height: parent.height + 6
                    radius: 10 + 3
                    color: Qt.rgba(жнецClass.accentColor.r, жнецClass.accentColor.g, жнецClass.accentColor.b, жнецMouseArea.containsMouse ? 0.06 : 0)
                    z: 0
                }
