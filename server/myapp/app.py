...
def download_program(key):
    ...
    # НЕ АКТИВИРУЕМ КЛЮЧ ПРИ СКАЧИВАНИИ
    # Активация происходит только когда пользователь вводит ключ в самой программе
    ...
    try:
        ...
        sys.stderr.write(f"Ошибка отдачи файла: {e}\n")
        return "❌ Ошибка при подготовке файла к скачиванию", 500
